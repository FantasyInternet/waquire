...
function renameVars(wast, search, replace) {
  ...
  while (true) {
    ...
    if (wast.substr(pos, 2) === ";;") {
      ...
      wast = wast.substr(0, pos + 1) + replace + wast.substr(pos + 1)
    }
  }
  return wast
}
